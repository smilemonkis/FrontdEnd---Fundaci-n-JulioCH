    ...
    <header className="sticky top-0 z-40 h-16 bg-card border-b border-border flex items-center justify-between px-4 md:px-6">
      <div className="flex items-center gap-3">
        ...
        <div className="hidden sm:block">
          <h2 className="font-heading text-sm font-semibold text-foreground">Panel del Aliado</h2>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="hidden md:block text-right">
          ...
          <p className="text-xs font-body text-muted-foreground">Aliado</p>
        </div>
